...
public class ChatGPTService {
    ...
    public String reviewFiles(List<FileData> files) {
        try {
            ...
            systemMessage.put("content", "You are a code review assistant. Provide detailed feedback on the code, including potential bugs, improvements, and best practices.");
